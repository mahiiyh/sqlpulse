...
export class NotificationService {
  ...
  async sendNotification(
    ...
    if (!config.enabled) {
      this.logger.info('Notification disabled, skipping', { scheduleId: payload.scheduleId });
      return false;
    }
    ...
    try {
      switch (config.channel) {
        ...
        default:
          this.logger.warn('Unknown notification channel', { channel: config.channel });
          return false;
      }
    } catch (error: any) {
  ...
  private async sendSlack(
    ...
    this.logger.info('Slack notification sent', { scheduleId: payload.scheduleId });
  ...
  private async sendWebhook(
    ...
    this.logger.info('Webhook notification sent', { scheduleId: payload.scheduleId });
